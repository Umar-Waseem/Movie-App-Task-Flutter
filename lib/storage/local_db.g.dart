    ...
    final databaseOptions = sqflite.OpenDatabaseOptions(
      ...
      onCreate: (database, version) async {
        await database.execute(
            'CREATE TABLE IF NOT EXISTS `MovieDatabaseModel` (`id` INTEGER NOT NULL, `original_title` TEXT NOT NULL, `backdrop_path` TEXT, `release_date` TEXT, `overview` TEXT, `poster_path` TEXT, PRIMARY KEY (`id`))');
...
class _$MovieDao extends MovieDao {
  ...
  @override
  Future<void> insertMovies(List<MovieDatabaseModel> movies) async {
    await _movieDatabaseModelInsertionAdapter.insertList(
